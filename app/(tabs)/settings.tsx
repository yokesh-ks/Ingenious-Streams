...
import { Theme, VideoQuality } from '@/types/channel';

export default function SettingsScreen() {
  const { settings, updateTheme, updateVideoQuality, toggleParentalControls } = useSettings();
  const tintColor = useThemeColor({}, 'tint');
  const borderColor = useThemeColor({ light: '#E5E5E5', dark: '#333' }, 'tabIconDefault');
  ...
  const renderThemeOption = (theme: Theme) => {
    ...
    return (
      ...
      >
        <ThemedText style={[styles.optionText, isSelected && { color: tintColor }]}>
            ...
            <View style={styles.sectionContent}>
              ...
              <View style={styles.switchRow}>
                ...
                <Switch
                  ...
                  thumbColor={settings.parentalControlsEnabled ? tintColor : '#f4f3f4'}
                />
              </View>
            </View>
          </Collapsible>
          ...
          <Collapsible title="About">
            <View style={styles.sectionContent}>
              <View style={styles.infoRow}>
                ...
                <ThemedText style={styles.infoValue}>IngeniousTV Player</ThemedText>
              </View>
              <View style={styles.infoRow}>
              ...
              <ThemedText style={[styles.sectionDescription, styles.aboutText]}>
                IngeniousTV Player delivers a clean, curated live-TV experience. Fast, simple, and
                built for viewers who value quality over noise.
              </ThemedText>
            </View>
          </Collapsible>
        </View>
